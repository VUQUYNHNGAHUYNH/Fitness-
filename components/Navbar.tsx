...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-[90%] mx-auto flex items-center justify-between space-x-8">
        {/* logo */}
        ...
        {/* Hamburger icon */}
        <div
          className={` ${menu ? "hidden" : ""} lg:hidden z-10`}
        ...
        <div
          className={` ${
            menu ? "fixed" : "hidden"
          } lg:hidden right-0 top-0 bg-gray-800 space-y-12 w-full h-full`}
        >
